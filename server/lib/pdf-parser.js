...
export function parsePdfText(text) {
  ...
  for (let i = 0; i < rawLines.length; i++) {
    ...
    if (state === 'HAVE_VENDOR') {
      ...
      // Check if it's a class+vendor continuation combo
      // e.g., "INNOVATIONS CIBA" where INNOVATIONS continues vendor and CIBA... no that doesn't work
      // Actually check for "INNOVATIONS" as second word of "CAROLINA INNOVATIONS"
